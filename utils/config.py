...
class Config:
    ...
    def initialize():
        ...
        parser.add_argument('--t_ckpt_path', default='/home/jinze/vgg_distillation/checkpoint/ckpt_1587573668_200_t.pth', type=str)
        parser.add_argument('--s_ckpt_path', default='/home/jinze/vgg_distillation/checkpoint/distill/ckpt_1587795507_99.pth', type=str)
