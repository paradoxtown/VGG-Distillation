...
class Config:
    ...
    def initialize():
        ...
        parser.add_argument('--s_ckpt_path', default='/content/drive/My Drive/vgg16_distillation/checkpoint/distill/ht/ckpt_init_ht.pth', type=str)
        ...
        parser.add_argument("--it", type=str2bool, default='False', help="is inter model loss using or not")
        parser.add_argument("--st", type=str2bool, default='False', help="")
        parser.add_argument("--lg", type=str2bool, default='False', help="")
        parser.add_argument("--sp", type=str2bool, default='True', help="")
        parser.add_argument("--at", type=str2bool, default='False', help="")
