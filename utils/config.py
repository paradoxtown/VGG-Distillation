...
class Config:
    ...
    def initialize():
        ...
        parser.add_argument('--t_ckpt_path', default='./checkpoint/ckpt_1587386983_100.pth', type=str)
        parser.add_argument('--s_ckpt_path', default='./checkpoint/distill/', type=str)
